...
public class AddressMaster implements java.io.Serializable {
    ...
    private Set hospitalMasters = new HashSet(0);
    ...
    public Set getHospitalMasters() {
        return this.hospitalMasters;
    }

    public void setHospitalMasters(Set hospitalMasters) {
        this.hospitalMasters = hospitalMasters;
    }
}
