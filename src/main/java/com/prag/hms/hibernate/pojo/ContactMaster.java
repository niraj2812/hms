...
public class ContactMaster implements java.io.Serializable {
    ...
    public ContactMaster(String id, UserAccess userAccessByCreatedBy, UserAccess userAccessByModifiedBy, String email, String homePhone, String officePhone, String mobileNo, String emergencyContactNo, String relationWithContactPerson, Date creationDate, Date modifiedDate, String dataSource, String entityStatus, String entityType, Set userMasters, Set hospitalMasters) {
        this.id = id;
